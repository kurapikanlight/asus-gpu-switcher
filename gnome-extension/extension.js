    ...
    class GpuToggle extends QuickSettings.QuickMenuToggle {
        ...
        async _refreshMode() {
            try {
                ...
                const dgpu = this._getCurrentValue(
                    output,
                    "dgpu_disable"
                );

                const mux = this._getCurrentValue(
                    output,
                    "gpu_mux_mode"
                );
        ...
        _showRestartDialog(modeName) {
            ...
            const message =
                new St.Label({
                    text:
                        "The GPU mode has been configured.\n\n" +
